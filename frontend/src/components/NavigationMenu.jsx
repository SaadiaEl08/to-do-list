...
const NavigationMenu = () => {
  ...
  return (
    <div className="bg-muted relative text-foreground w-full flex flex-col items-center justify-center z-10 xl:w-[4%]  xl:absolute xl:p-4 xl:rounded-md xl:top-1/2 xl:-translate-y-1/2 xl:ms-1">
